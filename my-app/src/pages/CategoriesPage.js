  ...
  const getCategoryDescription = (categoryName) => {
    const descriptions = {
      "Community Service & Advocacy":
        "Get involved in making a difference through volunteer work, activism, and community engagement.",
      "Arts & Culture":
        "Explore your creative side through visual arts, performing arts, and cultural experiences.",
      "Sports & Recreation":
        "Stay active and compete in various sports, from team competitions to outdoor adventures.",
      "Professional Development & Networking":
        "Build your career through networking, leadership opportunities, and professional skills.",
      "Technology & Engineering":
        "Dive into coding, innovation, and technical projects that shape the future.",
      "Health & Wellness":
        "Focus on physical and mental well-being through fitness, mindfulness, and health advocacy.",
      "Academic & Educational":
        "Expand your learning through research, tutoring, and educational outreach.",
    };
    return (
      descriptions[categoryName] ||
      "Explore opportunities in this exciting category."
    );
  };
    ...
    <Layout>
      <div className="categories-page">
        ...
        <p className="page-subtitle">
          Explore different club categories to find organizations that match
          your interests.
        </p>
